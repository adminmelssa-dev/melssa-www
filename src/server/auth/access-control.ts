...
export const statement = {
  ...
  finance: actions("create", "read", "update", "delete", "publish"),
  fundraising: actions(
    "create",
    "read",
    "update",
  ...
  scholarship: actions("create", "read", "update", "delete", "publish"),
...
export const siteAdminRole = ac.newRole({
  ...
  course: ["create", "read", "update", "delete"],
  event: ["create", "read", "update", "delete", "publish"],
  finance: ["create", "read", "update", "delete", "publish"],
  fundraising: ["create", "read", "update", "delete", "publish", "respond"],
  resource: ["create", "read", "update", "delete", "publish"],
